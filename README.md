...
| **Stanje** | v1.73.2 · 1551 testov (hermetičen suite — kontaminacija žetonov runnerja med datotekami odpravljena, TASK 76) · lint 0 · tsc 0 (`src/`; sledi git `main`) |
