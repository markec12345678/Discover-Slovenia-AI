...
| **Stanje** | v1.96.0 · 2521 testov (CI zelen) · lint 0 · tsc 0 (src/) · UX redesign Issue #3 + TASK 4 UX FIX PASS · ISSUE #4 VAL 1 (§3 lifecycle · §6 cene · §9 ure · §11 AI metering) + VAL 2 (§2 Trip enoten objekt · §8 Go Mode real-time kontekst · §13 sodelovanje z dovoljenji) + VAL 3 (§4 import rezervacij s parse→potrditev · §7 transport resnica · §14 proračun 5 vedric) + VAL 4 (§5 provider capability matrika · §10 deterministična personalizacija brez AI · §15 dokumenti poti · §16 offline z realnim E2E dokazom + dnevna navigacija Go Mode) · ZEMLJEVID 1.95.1 (SW CSP fix bele slike + Slovenija&Balkan z 125k pini) · CORE deluje brez AI ključa (Issue #2) |
