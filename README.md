...
> - **Koda:** `main` = glej git log (1.26.0 — HONESTY-2: weather varovalka obnove načrta + odmevna imena lokalov odstranjena iz AI promptov). CI ✅ (Build + Lint/TypeCheck). Kateri commit je v produkciji, preveriš s smoke skripto (točka 8).
