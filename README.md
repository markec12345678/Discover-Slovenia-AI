...
> - **Koda:** `main` = glej git log (1.10.0 — F7 skupnostni vodniki). CI ✅ (Build + Lint/TypeCheck). Kateri commit je v produkciji, preveriš s smoke skripto (točka 8). CI ✅ (Build + Lint/TypeCheck). Kateri commit je v produkciji, preveriš s smoke skripto (točka 8).
