...
#   2. openrouter-verify.sh    — živi test primarnega providerja
#   3. gemini-verify.sh        — živi test sekundarnega (poštena interpretacija)
...
bash "${HERE}/openrouter-verify.sh" --quick || RC=1
