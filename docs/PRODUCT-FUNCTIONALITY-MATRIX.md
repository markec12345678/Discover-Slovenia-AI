...
> **Datum:** 2026-09-26 · **Verzija:** 1.100.3 (audit) / 1.102.0 (T5-B) / 1.104.0 (T5-D) / 1.106.0 (TASK 28 Tier 1: live-sync + overjena rezervacija) / 1.107.0 (TASK 30 Tier 1 #4: Lighthouse + CWV vrata) / 1.108.0 (TASK 31 Tier 1 #3: uvoz rezervacij prek e-pošte — TripItov model) / 1.109.0 (TASK 32 Tier 1 #5: EN blog + čiščenje de/it) / 1.110.0 (TASK 33 Tier 2 #1: koledar razpoložljivosti — preprečitev overbookinga) / 1.111.0 (TASK 34 Tier 2 #2: payout ledger — mesečne poravnave ponudnika) / 1.111.1 (TASK 35: payout sweep števec olderOpenCount — UI semantika izdaje) / 1.112.0 (ISSUE #8 / TASK 36 Faza 1: Discovery UX 2.0 — kanonski Dodaj v mojo pot + Moja pot + tab vrstica + lupina) · **HEAD ob auditu:** a854404 · **Popravljeni v T5-B (1.102.0):** H1, H2, M3-chat, M4, M5, M6 · **Popravljeni v T5-C (1.103.0):** M11, M9-pot · **Popravljeni v T5-D (1.104.0):** M1, M7, M8, M9-arhiv, M10 (označeno spodaj)
