...
| `chat_geo_answered` (1.41) | AI klepet odgovori z ≥ 1 krajem na mini zemljevidu | vsak geo odgovor | `osm_count`, `t1_count`, `t2_count` (1.44) | doseg „generative spatial“ odgovorov (kje je hrana/pijača/tržnica) po plasti porekla; `t2_count` = citani uradni viri STO, izrisani kot turkizni pini (zemljevid odseva odgovor — samo dejansko citirani viri) |
