...
export function PrijavaView() {
  ...
  return (
    <main className="flex-1 flex flex-col bg-muted/30">
      {/* TASK 8 / D8-E (P-NAV-1): lastni header (logo + "← Nazaj na spletno
          stran") ODSTRANJEN — obe povezavi vodita na "/", kar pokriva
          logotip v Navigation (zero-loss); lupino izrisuje server ovoj
          page.tsx (Navigation solid + Footer). */}
