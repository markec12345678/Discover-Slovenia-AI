...
// ============================================================================
// /owner/reset-gesla?token=... — nastavitev novega gesla (P0-4)
// ============================================================================
// Javna stran (povezava iz e-pošte). Prebere žeton iz URL-ja, uporabnik
// vpiše novo geslo → POST /api/owner/reset-password.
// ============================================================================
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            {!done && (
              <p className="text-sm text-muted-foreground mt-1">
                Nastavite novo geslo za vaš ponudniški račun.
              </p>
            )}
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-xs text-center text-muted-foreground">
              ...
              <Link href="/owner/prijava" className="hover:underline">
                Nazaj na prijavo
              </Link>
            </p>
          </CardContent>
